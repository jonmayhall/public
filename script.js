...
const roles = [
  ...
  },
  {
    ...
    rows: 3,
    cols: [
      "DMS ID", "Login", "Mobile App Menu", "MCI", "Workflow",
      "Search Bar", "RO Assignment", "DMS History", "Prev. Declines",
      "OCR", "Edit ASR", "ShopChat", "Status Change", "MPI Send", "SOP"
    ]
  },
  {
    id: "parts",
  ...
  },
  {
    ...
    rows: 2,
    cols: [
      "DMS ID", "Login", "PU&D", "Notifications"
    ]
  }
];
...
roles.forEach(role => {
  ...
  div.innerHTML = `
    ...
    <div class="table-footer">
      <button class="add-row" data-target="${role.id}">+</button>
    </div>
...
document.getElementById("pdfButton").addEventListener("click", () => {
  ...
  import("https://cdn.jsdelivr.net/npm/html2pdf.js@0.10.1/dist/html2pdf.bundle.min.js")
    .then(html2pdf => html2pdf.default()
      .from(active)
      .save(`${active.id}.pdf`)
    );
});
